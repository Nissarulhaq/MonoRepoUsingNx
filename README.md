...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/qN1iO1jvOz)
...
```sh
npx nx serve DoctorApp
```

To create a production bundle:

```sh
npx nx build DoctorApp
```

To see all available targets to run for a project, run:

```sh
npx nx show project DoctorApp
```
