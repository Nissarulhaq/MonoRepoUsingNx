...
import {
  ApplicationProvider, Layout, Text
...
import { decrement } from '@nx-apps/store';
import { increment } from '@nx-apps/store';
import { useAppDispatch, useAppSelector } from '@nx-apps/store';
        ...
        >
          ...
          >
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: "center", flexDirection: 'row' }}>
              <Text status='warning' category='h2'>Global Count:</Text>
              <Text
                status='danger'
                category='h1'
